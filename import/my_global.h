...
#ifndef HAVE_STRUCT_timespec1 /* Windows before VS2015 */
/*
...
#endif /* !HAVE_STRUCT_timespec1 */

C_MODE_START
extern ulonglong my_getsystime(void);
C_MODE_END

static inline void set_timespec1_nsec(struct timespec1 *abstime, ulonglong nsec)
{
#ifdef HAVE_STRUCT_timespec1
...
static inline void set_timespec1(struct timespec1 *abstime, ulonglong sec)
{
  set_timespec1_nsec(abstime, sec * 1000000000ULL);
}

/**
   Compare two timespec1 structs.

   @retval  1 If ts1 ends after ts2.
   @retval -1 If ts1 ends before ts2.
   @retval  0 If ts1 is equal to ts2.
*/
static inline int cmp_timespec1(struct timespec1 *ts1, struct timespec1 *ts2)
{
#ifdef HAVE_STRUCT_timespec1
...
static inline ulonglong diff_timespec1(struct timespec1 *ts1, struct timespec1 *ts2)
{
#ifdef HAVE_STRUCT_timespec1
